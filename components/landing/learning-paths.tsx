...
const paths = [
  {
    ...
    description: "Master frontend, backend, and deployment to become a complete developer.",
    courses: 12,
    duration: "6 months",
  ...
  },
  {
    ...
    description: "Learn statistics, machine learning, and data visualization from scratch.",
    courses: 10,
    duration: "5 months",
  ...
  },
  {
    ...
    description: "Build expertise in CI/CD, containers, and infrastructure automation.",
    courses: 8,
    duration: "4 months",
